...
The Clean Slate script provides operational safety nets, prompts for credentials instead of hard code, provides step by step feedback of script operation, and also performs RPM backup of the sslo rpm package for reinstallation after the script exits.
