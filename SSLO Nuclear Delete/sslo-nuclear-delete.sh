...
# =============================================================================
# Version:       12.0
# Based on:      Kevin Stewart (F5 Networks) v7.0 - October 2020
# Requirements:  SSL Orchestrator 5.0 or higher / TMOS 17.x, 21.x
#
# PURPOSE:
#   Forcibly removes all SSL Orchestrator (SSLO) configuration objects,
#   clears REST storage, and reinstalls the SSLO RPM for a clean slate.
#
# WARNING:
#   THIS SCRIPT IS DESTRUCTIVE. It will permanently delete ALL SSLO
#   configuration on this device. This action cannot be undone.
#   Do NOT run this on a device with active production SSLO traffic
#   unless you have a plan to restore service.
#
# USAGE:
...
#
# OUTPUT:
#   A log file is written to /var/log/sslo-nuke-<timestamp>.log
# =============================================================================
...
LOGFILE="/var/log/sslo-nuke-${TIMESTAMP}.log"
...
confirm_execution() {
    ...
    log_ok "Confirmed by user. Proceeding with nuclear delete."
}
...
main() {
    # Initialise log
    echo "SSL Orchestrator Nuclear Delete - v12.0" | tee "${LOGFILE}"
